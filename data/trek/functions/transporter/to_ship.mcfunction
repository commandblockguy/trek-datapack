...
execute if entity @e[tag=trekTmpCurrent,tag=!trekShieldDisabled,scores={trekShieldHealth=25..}] run effect give @s minecraft:wither 10 2
execute if entity @e[tag=trekTmpDestination,tag=!trekShieldDisabled,scores={trekShieldHealth=25..}] run effect give @s minecraft:wither 10 2
