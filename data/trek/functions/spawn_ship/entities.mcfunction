...
summon minecraft:hopper_minecart ^-9.5 ^5 ^44.4  {Tags:["trek","trekTorpedoCollector","trekTmpSpawn"],Items:[{Slot: 0b, id: "minecraft:fire_charge", tag: {display: {Name: '{"text":"Torpedo"}'}}, Count: 63b}, {Slot: 1b, id: "minecraft:barrier", Count: 1b}, {Slot: 2b, id: "minecraft:barrier", Count: 1b}, {Slot: 3b, id: "minecraft:barrier", Count: 1b}, {Slot: 4b, id: "minecraft:barrier", Count: 1b}]}
